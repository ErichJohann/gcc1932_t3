...
\begin{frame}{Modelos e Configurações Comparadas}
  ...
  \vspace{4pt}
  \small
  Configurações avaliadas: \textbf{Baseline 1} pré-treinado (pt\_core\_news\_lg), \textbf{Baseline 2} treinado só no DDsmall, \textbf{Proposta 1} com EntityRuler e \textbf{Proposta 2} com DDsmall + pseudo-anotado.\\[4pt]
\end{frame}
...
\begin{frame}{Resultado principal}
  \begin{columns}[T]
    ...
    \begin{column}{.38\textwidth}
      ...
      \vspace{8pt}
      \small
      Entre as configurações, o melhor resultado ficou com o \textbf{Baseline 2}. A pseudo-anotação não melhorou a generalização no teste, e a queda foi especialmente forte em \textbf{Pessoa}, enquanto \textbf{Organização} caiu menos.
    \end{column}
  \end{columns}
\end{frame}
